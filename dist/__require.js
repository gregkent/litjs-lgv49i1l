...
var __reExport = (target, module, desc) => {
  ...
  return target;
}, __toModule = (module) => __reExport(__markAsModule(__defProp(module != null ? __create(__getProtoOf(module)) : {}, "default", module && module.__esModule && "default" in module ? { get: () => module.default, enumerable: true } : { value: module, enumerable: true })), module);
...
init_vite_shims();
init_vite_shims();
var _a, _b$1, _c$1, _d$1, _e$1, INTERNAL = true, issueWarning$1;
(_a = globalThis.litIssuedWarnings) !== null && _a !== void 0 || (globalThis.litIssuedWarnings = new Set()), issueWarning$1 = (code, warning) => {
...
init_vite_shims();
init_vite_shims();
var NODE_MODE = false, global = window, supportsAdoptingStyleSheets = global.ShadowRoot && (global.ShadyCSS === void 0 || global.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, constructionToken = Symbol(), cssTagCache = new WeakMap(), CSSResult = class {
  ...
  supportsAdoptingStyleSheets ? renderRoot.adoptedStyleSheets = styles.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet) : styles.forEach((s) => {
    let style = document.createElement("style"), nonce = global.litNonce;
...
((_d3 = global4.litHtmlVersions) !== null && _d3 !== void 0 ? _d3 : global4.litHtmlVersions = []).push("2.7.2");
...
((_c4 = globalThis.litElementVersions) !== null && _c4 !== void 0 ? _c4 : globalThis.litElementVersions = []).push("3.3.1");
...
const modules = { "lit-html": () => __eager_import_0, "lit": () => __eager_import_1 };
const aliases = {};
